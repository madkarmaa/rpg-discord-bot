...
setup_logging(handler=logging.FileHandler(filename=f'./logs/{rightNow}.log', encoding='utf-8', mode='w'),
              level=logging.INFO)

client = MyClient(
    command_prefix=commands.when_mentioned_or("my_message_content_perm_must_be_disabled"),
    ...
    _data_database_manager=ItemsDatabaseManager(database_file_path="./databases/items.db",
