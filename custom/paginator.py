    ...
    def __init__(
        ...
        *,
        ...
        self.page_counter = PageCounter(
            current_page=current_page, total_pages=len(pages)
        )
        ...
        self.add_item(
            self.page_counter
        )  # TODO maybe move the button to the middle of the navigation buttons
...
class PageCounter(Button):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            label=f"{current_page + 1}/{total_pages}", style=style, disabled=True
        )
